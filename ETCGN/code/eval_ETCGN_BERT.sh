...
# -------------------ETCGN_BERT_base Evaluation Shell Script--------------------

if true; then
  model_name=ETCGN_BERT_base
  ...
  nohup python3 -u test.py \
    ...
    --use_model bert \
    --pretrain_model checkpoint/ETCGN_BERT_base_best.pt \
...
# -------------------ETCGN_BERT_large Evaluation Shell Script--------------------

if false; then
  model_name=ETCGN_BERT_large
  ...
  nohup python3 -u test.py \
    ...
    --model_name ${model_name} \
    --use_model bert \
    --pretrain_model checkpoint/ETCGN_BERT_large_best.pt \
    --batch_size ${batch_size} \
    --test_batch_size ${test_batch_size} \
    --gcn_dim 1064 \
    --gcn_layers 2 \
